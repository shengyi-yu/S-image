...
import cn.com.laning.shengimage.manager.upload.UrlPictureUpload;
    ...
    public PictureVO uploadPicture(Object inputSource, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        if (pictureId != null) {
            ...
            if (oldPicture != null && oldPicture.getSpaceId() != null) {
                oldPicSize = oldPicture.getPicSize() != null ? oldPicture.getPicSize() : 0L;
            }
        }
        ...
        transactionTemplate.execute(status -> {
            ...
            if (finalSpaceId != null) {
                // 新增时 +newSize, 更新时 +newSize - oldSize（净差值）
                long sizeDiff = picture.getPicSize() - finalOldPicSize;
                // 新增时 +1, 更新时 +0
                int countDiff = (finalPictureId != null) ? 0 : 1;
